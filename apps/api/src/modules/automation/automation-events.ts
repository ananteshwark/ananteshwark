...
export const AUTOMATION_EVENTS: AutomationEventDef[] = [
  ...
  { event: 'i9.section2_overdue', label: 'I-9 Section 2 past its deadline', module: 'hr' },
  { event: 'i9.reverification_due', label: 'I-9 reverification due', module: 'hr' },
  ...
  // Licensing / billing
  { event: 'license.invoice_generated', label: 'License invoice generated by the billing cycle', module: 'licensing' },

  // Reporting
  { event: 'report.schedule_sent', label: 'Scheduled report delivered by email', module: 'analytics' },
];
