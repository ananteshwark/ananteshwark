...
| P1.2 | **Bank connectivity formats.** Payment runs exist; no ISO 20022 pain.001 export / camt.053 import (bank files page is India-format oriented). | S/4 Advanced Payment Management | ✅ **pain.001 BUILT** — `GET /finance/payment-runs/:id/pain001` renders pain.001.001.03 (one credit transfer per vendor, IBAN or Othr fallback, BIC or IFSC clearing routing, remittance from bill numbers, control sums). camt.053 statement import remains a follow-up. |
